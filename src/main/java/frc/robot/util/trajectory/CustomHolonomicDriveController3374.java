...
public class CustomHolonomicDriveController3374 {
  ...
  public CustomHolonomicDriveController3374(
  ...
  public ChassisSpeeds calculate(
    ...
    // m_poseError = currentPose.relativeTo(poseRef);
    m_rotationError = angleRef.minus(currentPose.getRotation());
    // m_rotationError = currentPose.getRotation().minus(angleRef);
