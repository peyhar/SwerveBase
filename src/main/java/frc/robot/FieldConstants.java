...
public final class FieldConstants {
  ...
  public static final class LoadingZone {
    ...
    public static final Translation2d[] regionCorners =
        new Translation2d[] {
          new Translation2d(midX, rightY), // Start at lower left next to border
  ...
  private static final Pose2d[] automationTargetPoses = {
    new Pose2d(1.77, 0.43, Rotation2d.fromDegrees(180)),
    new Pose2d(1.77, 1.06, Rotation2d.fromDegrees(180)),
    new Pose2d(1.77, 1.63, Rotation2d.fromDegrees(180)),
    new Pose2d(1.77, 2.20, Rotation2d.fromDegrees(180)),
    new Pose2d(1.77, 2.76, Rotation2d.fromDegrees(180)),
    new Pose2d(1.77, 3.32, Rotation2d.fromDegrees(180)),
    new Pose2d(1.77, 3.87, Rotation2d.fromDegrees(180)),
    new Pose2d(1.77, 4.43, Rotation2d.fromDegrees(180)),
    new Pose2d(1.77, 5.00, Rotation2d.fromDegrees(180))
  };

  public static Pose2d getTargetPose(int Target) {
    if (DriverStation.getAlliance() == Alliance.Red) {
      return allianceFlip(automationTargetPoses[(Target - 1)]);
    } else {
      return automationTargetPoses[(Target - 1)];
    }
  }
  ...
  public static final Map<Integer, Pose3d> aprilTags =
      Map.of(
          ...
          new Pose3d(
              Units.inchesToMeters(610.77),
              Units.inchesToMeters(174.19), // FIRST's diagram
              // has a typo (it
              // says 147.19)
              Units.inchesToMeters(18.22),
              new Rotation3d(0.0, 0.0, Math.PI)),
